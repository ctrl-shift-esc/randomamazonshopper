...
casper.thenEvaluate(function(){
	document.querySelector('input[name="email"]').setAttribute('value', "amazonshopperbot@gmail.com");
	document.querySelector('input[name="password"]').setAttribute('value', "amazonshopperbot");
